...
#define ComM_GetLastStateChange(Index)                                
...
#define ComM_GetUserModeNotiFunc(Index)                               
...
#define ComM_SetLastStateChange(Index, Value)                         
...
#define ComM_HasLastStateChange()                                     
#define ComM_HasPnc()                                                 
...
#define ComM_HasUserModeNotiFunc()                                    
...
#define ComM_IncLastStateChange(Index)                                
...
#define ComM_DecLastStateChange(Index)                                
