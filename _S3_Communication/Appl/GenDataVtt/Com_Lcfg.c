 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Com_Lcfg.c
 *   Generation Time: 2016-04-27 09:42:42
...
/*lint -restore */
CONST(ComCbkRxAckType, COM_CONST) Com_CbkRxAckFuncPtr[2] = {
  /* Index    CbkRxAckFuncPtr                            Referable Keys */
  /*     0 */Rte_COMCbk_sig_State_RearLeftDoor_In  ,  /* [/ActiveEcuC/Com/ComConfig/sig_State_RearLeftDoor_In] */
  /*     1 */Rte_COMCbk_sig_State_RearRightDoor_In    /* [/ActiveEcuC/Com/ComConfig/sig_State_RearRightDoor_In] */
};
