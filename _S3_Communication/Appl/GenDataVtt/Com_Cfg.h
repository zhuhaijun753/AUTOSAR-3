 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Com_Cfg.h
 *   Generation Time: 2016-07-21 15:27:23
...
#define COM_ISDEF_CBKRXACKFUNCPTRUSEDOFRXSIGINFO                      STD_ON
...
#define COM_EQ2_CBKRXACKFUNCPTRUSEDOFRXSIGINFO                        TRUE
...
#define COM_RECEPTION_DM_CONTROL_API         STD_OFF
...
#define Com_GetSizeOfCbkRxAckFuncPtrOfPCConfig()                      2U  /**< the number of accomplishable value elements in Com_CbkRxAckFuncPtr */
...
#define Com_GetCbkRxAckFuncPtrIdxOfRxSigInfo(Index)                   ((Com_CbkRxAckFuncPtrIdxOfRxSigInfoType)((Index)))  /**< the index of the 0:1 relation pointing to Com_CbkRxAckFuncPtr */
#define Com_IsCbkRxAckFuncPtrUsedOfRxSigInfo(Index)                   (((TRUE)) != FALSE)  /**< TRUE, if the 0:1 relation has minimum 1 relation pointing to Com_CbkRxAckFuncPtr */
...
/** 
  ...
  \{
*/ 
/**   \brief  type used to iterate Com_CbkRxAckFuncPtr */
typedef uint8_least Com_CbkRxAckFuncPtrIterType;
...
/**   \brief  value based type definition for Com_CbkRxAckFuncPtrIdxOfRxSigInfo */
typedef uint8 Com_CbkRxAckFuncPtrIdxOfRxSigInfoType;

/**   \brief  value based type definition for Com_CbkRxAckFuncPtrUsedOfRxSigInfo */
...
/**   \brief  value based type definition for Com_SizeOfCbkRxAckFuncPtr */
...
/*lint -restore */
extern CONST(ComCbkRxAckType, COM_CONST) Com_CbkRxAckFuncPtr[2];
