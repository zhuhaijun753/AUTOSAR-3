 ...
 *  Rte_ComHookRx_sig_State_RearLeftDoor_In
 *  Rte_ComHookRx_sig_State_RearRightDoor_In
...
# if defined (Rte_ComHookRx_sig_State_RearLeftDoor_In) && (RTE_VFB_TRACE == 0)
#  undef Rte_ComHookRx_sig_State_RearLeftDoor_In /* PRQA S 0841 */ /* MD_MSR_19.6 */
# endif
# if defined (Rte_ComHookRx_sig_State_RearLeftDoor_In)
#  undef Rte_ComHookRx_sig_State_RearLeftDoor_In /* PRQA S 0841 */ /* MD_MSR_19.6 */
FUNC(void, RTE_APPL_CODE) Rte_ComHookRx_sig_State_RearLeftDoor_In(void); /* PRQA S 0850, 0777 */ /* MD_MSR_19.8, MD_Rte_0777 */
# else
#  define Rte_ComHookRx_sig_State_RearLeftDoor_In() ((void)(0)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
# endif /* Rte_ComHookRx_sig_State_RearLeftDoor_In */

# if defined (Rte_ComHookRx_sig_State_RearRightDoor_In) && (RTE_VFB_TRACE == 0)
#  undef Rte_ComHookRx_sig_State_RearRightDoor_In /* PRQA S 0841 */ /* MD_MSR_19.6 */
# endif
# if defined (Rte_ComHookRx_sig_State_RearRightDoor_In)
#  undef Rte_ComHookRx_sig_State_RearRightDoor_In /* PRQA S 0841 */ /* MD_MSR_19.6 */
FUNC(void, RTE_APPL_CODE) Rte_ComHookRx_sig_State_RearRightDoor_In(void); /* PRQA S 0850, 0777 */ /* MD_MSR_19.8, MD_Rte_0777 */
# else
#  define Rte_ComHookRx_sig_State_RearRightDoor_In() ((void)(0)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
# endif /* Rte_ComHookRx_sig_State_RearRightDoor_In */
