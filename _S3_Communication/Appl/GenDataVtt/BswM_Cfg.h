 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: BswM_Cfg.h
 *   Generation Time: 2016-04-25 15:42:16
...
#define BSWM_ISDEF_IDOFRULES                                          STD_ON
#define BSWM_ISDEF_INITOFRULES                                        STD_ON
#define BSWM_ISDEF_RULESIND                                           STD_ON
...
#define BSWM_EQ2_RULESINDENDIDXOFIMMEDIATEUSER                        1U
...
#define BSWM_EQ2_IDOFRULES                                            0U
#define BSWM_EQ2_INITOFRULES                                          BSWM_UNDEFINED
#define BSWM_EQ2_RULESIND                                             0U
...
{
  CanSM_BswMCurrentStateType MRP_CanSMInd_CAN00_f26020e5[1];
...
{
  BswM_ModeRequestQueueType MRP_CanSMInd_CAN00_f26020e5[1];
...
{  /* PRQA S 0750 */  /* MD_CSL_18.4 */
  BswM_ActionListQueueType raw[3];
...
{  /* PRQA S 0750 */  /* MD_CSL_18.4 */
  BswM_ModeRequestQueueType raw[1];
