...
FUNC(void, RTE_CODE) Rte_COMCbk_sig_State_RearLeftDoor_In(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
...
FUNC(void, RTE_CODE) Rte_COMCbk_sig_State_RearRightDoor_In(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
  if (Rte_InitState == RTE_STATE_INIT)
  {
