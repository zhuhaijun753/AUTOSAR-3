 ...
 * API prototypes
 *********************************************************************************************************************/
FUNC(Std_ReturnType, RTE_CODE) Rte_Switch_ComM_UM_USR_CHNL_CAN00_currentMode(uint8 nextMode); /* PRQA S 0850 */ /* MD_MSR_19.8 */
 ...
 * Rte_Switch_<p>_<m>
 *********************************************************************************************************************/
#  define Rte_Switch_UM_USR_CHNL_CAN00_currentMode Rte_Switch_ComM_UM_USR_CHNL_CAN00_currentMode
