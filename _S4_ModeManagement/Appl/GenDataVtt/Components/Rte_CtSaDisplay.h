...
#  define Rte_Read_CtSaDisplay_PpDisplayState_DeLightOnOffCounter(data) (*(data) = 0U, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_PpDisplayState_DeOdometerValue Rte_Read_CtSaDisplay_PpDisplayState_DeOdometerValue
#  define Rte_Read_CtSaDisplay_PpDisplayState_DeOdometerValue(data) (*(data) = 0U, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Read_CtSaDisplay_PpDisplayState_DeOdometerWriteRequestPending(data) (*(data) = FALSE, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
