 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: NvM_Cfg.c
 *   Generation Time: 2016-04-06 10:40:13
...
struct PermanentRamBlockLengthChecks {
  ...
  NvM_LengthCheck Block_CpApMySwcSnNvMPimOdometer : SizeOfRamBlockDoesNotMatchConfiguredLength(Rte_CpApMySwc_PimOdometer, 0, 4U);
  NvM_LengthCheck Block_CpApMySwcSnNvMPimLightOnOffCounter : SizeOfRamBlockDoesNotMatchConfiguredLength(Rte_CpApMySwc_PimLightOnOffCounter, 0, 4U);
...
struct PermRomBlockLengthCheck {
  NvM_LengthCheck Block_CpApMySwcSnNvMPimOdometer : SizeOfRomBlockDoesNotMatchConfiguredLength(Rte_CtApMySwc_CalOdometer, 4U);
