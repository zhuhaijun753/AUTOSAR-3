 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Dem_Lcfg.h
 *   Generation Time: 2016-03-29 16:19:11
...
#define Dem_C_GetIdNumberOfDataCollectionTable(Index)                 ((Dem_C_IdNumberOfDataCollectionTableType)((Index)))
#define Dem_C_GetDataCollectionTableEdr2CollInd(Index)                ((Dem_C_DataCollectionTableEdr2CollIndType)(((Index) + 1)))  /**< the indexes of the 1:1 sorted relation pointing to Dem_C_DataCollectionTable */
#define Dem_C_GetDataElementTableCol2ElmtInd(Index)                   ((Dem_C_DataElementTableCol2ElmtIndType)(((Index) + 1)))  /**< the indexes of the 1:1 sorted relation pointing to Dem_C_DataElementTable */
