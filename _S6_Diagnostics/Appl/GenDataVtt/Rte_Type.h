...
typedef struct
{
  boolean Rte_ModeSwitchAck_Dcm_DcmEcuReset_DcmEcuReset_Ack;
} Rte_AckFlagsType;
...
extern VAR(IdtDoorState, RTE_VAR_NOINIT) Rte_Irv_CpApMySwc_IrvDoorStateOld; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
