 ...
 * API prototypes
 *********************************************************************************************************************/
FUNC(uint8, RTE_CODE) Rte_Mode_BswM_Notification_BswModeSwitch_DcmEcuReset_DcmEcuReset(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(uint8, RTE_CODE) Rte_Mode_BswM_Notification_ESH_ModeNotification_BswM_MDGP_ESH_Mode(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(uint8, RTE_CODE) Rte_Mode_BswM_Notification_SWCModeSwitch_BswM_MdgBswMRequestShutdown_BswM_MDGP_MdgBswMRequestShutdown(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
#  define Rte_Mode_Notification_SWCModeSwitch_BswM_MdgBswMRequestShutdown_BswM_MDGP_MdgBswMRequestShutdown Rte_Mode_BswM_Notification_SWCModeSwitch_BswM_MdgBswMRequestShutdown_BswM_MDGP_MdgBswMRequestShutdown
