...
#  else
FUNC(Std_ReturnType, RTE_CTAPMYSWC_APPL_CODE) CBReadData_OccurrenceCounter_OccurenceCounter_ReadData(P2VAR(DataArray_Type_4, AUTOMATIC, RTE_CTAPMYSWC_APPL_VAR) Data); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
#  endif
...
#  else
FUNC(Std_ReturnType, RTE_CTAPMYSWC_APPL_CODE) CBReadData_OdometerValue_OdometerValue_ReadData(P2VAR(DataArray_Type_4, AUTOMATIC, RTE_CTAPMYSWC_APPL_VAR) Data); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
#  endif
#  define RTE_STOP_SEC_CTAPMYSWC_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
