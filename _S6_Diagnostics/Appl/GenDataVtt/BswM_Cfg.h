 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: BswM_Cfg.h
 *   Generation Time: 2016-04-27 15:59:57
...
/* -----------------------------------------------------------------------------
    &&&~ RULE DEFINES
 ----------------------------------------------------------------------------- */
#define BswMConf_BswMRule_BswMRule_EcuShutdown (1) 
...
#define BswMConf_BswMRule_BswMRule_DcmEcuReset (0) 
...
typedef struct sBswM_ActionListQueueStructTag
{
  ...
  BswM_ActionListQueueType AL_BswMActionList_Mcu_PerformReset[1];
...
{  /* PRQA S 0750 */  /* MD_CSL_18.4 */
  BswM_ActionListQueueType raw[21];
