...
CONST(CanIf_RxPduCanIdType, CANIF_CONST) CanIf_RxPduCanId[4] = {
  ...
  /*     3 */    0x0210U  /* msg_Receive_oCAN00_Rx_3abd61be, 2.0- or FD-PDU */                   
};
...
CONST(CanIf_RxPduConfigType, CANIF_CONST) CanIf_RxPduConfig[4] = {
  ...
  { /*     3 */ PduRConf_PduRSrcPdu_SRC_Can_PT_msg_Receive_0fb271d2_In,  1U,                    3UL  /* PduR_CanIfRxIndication */ }   /* [PDU: msg_Receive_oCAN00_Rx_3abd61be, CanId: 0x210] */
};
#define CANIF_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
...
CONST(CanIf_RxPduMaskType, CANIF_CONST) CanIf_RxPduMask[4] = {
  ...
  /*     3 */   0x07FFU  /* msg_Receive_oCAN00_Rx_3abd61be */                   
};
#define CANIF_STOP_SEC_CONST_16BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
...
CONST(CanIf_TxBufferPrioByCanIdByteQueueMappedTxPdusType, CANIF_CONST) CanIf_TxBufferPrioByCanIdByteQueueMappedTxPdus[3] = {
  ...
  { /*     2 */            2UL  /* /ActiveEcuC/CanIf/CanIfInitCfg/msg_Transmit_oCAN00_Tx_3abd61be */               }   /* [/ActiveEcuC/CanIf/CanIfInitCfg/CanIfBufferCfg_Tx_Std_0fb271d2] */
};
#define CANIF_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
...
CONST(CanIf_TxPduConfigType, CANIF_CONST) CanIf_TxPduConfig[3] = {
  ...
  { /*     2 */ 0x0200U, PduRConf_PduRDestPdu_DST_Can_PT_msg_Transmit_0fb271d2_Out,           0UL  /* /ActiveEcuC/CanIf/CanIfCtrlDrvCfg/CT_CAN00_e98c47e6 */,  1U,  0U,                      0UL  /* NULL_PTR */             }   /* [PDU: msg_Transmit_oCAN00_Tx_3abd61be]               */  /* [/ActiveEcuC/CanIf/CanIfInitCfg/msg_Transmit_oCAN00_Tx_3abd61be] */
};
#define CANIF_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
...
CONST(CanIf_TxPduQueueIndexType, CANIF_CONST) CanIf_TxPduQueueIndex[3] = {
  ...
  { /*     2 */        2UL  /* /ActiveEcuC/CanIf/CanIfInitCfg/msg_Transmit_oCAN00_Tx_3abd61be */               }   /* [msg_Transmit_oCAN00_Tx_3abd61be, BasicCAN TxPdu with Tx-buffer]               */  /* [/ActiveEcuC/CanIf/CanIfInitCfg/msg_Transmit_oCAN00_Tx_3abd61be, /ActiveEcuC/CanIf/CanIfCtrlDrvCfg/CT_CAN00_e98c47e6] */
};
#define CANIF_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
