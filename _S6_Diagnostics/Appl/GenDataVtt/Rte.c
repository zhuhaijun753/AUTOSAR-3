...
VAR(IdtDoorState, RTE_VAR_NOINIT) Rte_Irv_CpApMySwc_IrvDoorStateOld; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
...
VAR(uint8, RTE_VAR_NOINIT) Rte_ModeMachine_Dcm_DcmEcuReset_DcmEcuReset; /* PRQA S 3408 */ /* MD_Rte_3408 */
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_NvM_NvM_RpNotifyJobEnd_CpApMySwcSnNvM_PimOdometer_JobFinished(NvM_ServiceIdType ServiceId, NvM_RequestResultType JobResult) /* PRQA S 0850, 1505, 3673 */ /* MD_MSR_19.8, MD_MSR_8.10, MD_Rte_Qac */
{
  Std_ReturnType ret = RTE_E_OK; /* PRQA S 3197 */ /* MD_Rte_3197 */
...
FUNC(uint8, RTE_CODE) Rte_Mode_BswM_Notification_BswModeSwitch_DcmEcuReset_DcmEcuReset(void) /* PRQA S 3408 */ /* MD_Rte_3408 */
{
...
FUNC(uint8, RTE_CODE) Rte_Mode_BswM_Notification_SWCModeSwitch_BswM_MdgBswMRequestShutdown_BswM_MDGP_MdgBswMRequestShutdown(void) /* PRQA S 3408 */ /* MD_Rte_3408 */
{
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Switch_Dcm_DcmEcuReset_DcmEcuReset(uint8 nextMode) /* PRQA S 0850, 1505 */ /* MD_MSR_19.8, MD_MSR_8.10 */
{
  Std_ReturnType ret = RTE_E_OK;
