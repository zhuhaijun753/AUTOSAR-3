...
#define NvMConf_NvMBlockDescriptor_CpApMySwcSnNvMPimLightOnOffCounter (2UL) 
#define NvMConf_NvMBlockDescriptor_DemAdminDataBlock (3UL) 
...
#define NvMConf_NvMBlockDescriptor_CpApMySwcSnNvM_PimOdometer (13UL) 
