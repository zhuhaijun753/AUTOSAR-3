 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Dem_Lcfg.c
 *   Generation Time: 2016-03-29 15:19:13
...
CONST(Dem_C_DataCollectionTableType, DEM_CONST) Dem_C_DataCollectionTable[3] = {
  ...
  { /*     0 */             0U, DEM_C_NO_DATAELEMENTTABLECOL2ELMTINDENDIDXOFDATACOLLECTIONTABLE, DEM_C_NO_DATAELEMENTTABLECOL2ELMTINDSTARTIDXOFDATACOLLECTIONTABLE,      0x00U, DEM_CFG_EREC_TYPE_GLOBAL },  /* [#NoDataCollectionConfigured] */
...
CONST(Dem_C_DataElementTableType, DEM_CONST) Dem_C_DataElementTable[3] = {
  ...
  { /*     2 */         28U,          4U,  (Dem_ReadDataFPtrType) /* PRQA S 0313 */ /* MD_DEM_11.1 */ Rte_Call_CBReadData_OdometerValue_OdometerValue_ReadData        }   /* [#OdometerValue_OdometerValue, EdrOdometerValue] */
};
#define DEM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
...
CONST(Dem_C_MemoryBlockIdType, DEM_CONST) Dem_C_MemoryBlockId[10] = {
  ...
  /*     0 */NvMConf_NvMBlockDescriptor_DemAdminDataBlock /*NvMBlockId=3*/     ,  /* [Dem_AdminData] */
